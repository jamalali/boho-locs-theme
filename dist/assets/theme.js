...
var scrollY = void 0;
var scrollDisabledClass = 'scrolling-off';
...
var _marquee = __webpack_require__(331);

var _mobileMenu = __webpack_require__(332);

var MobileMenu = _interopRequireWildcard(_mobileMenu);

var _carousel = __webpack_require__(333);
...
function init() {
    ...
    for (var i = 0; i < toggles.length; i++) {
        toggles[i].addEventListener('click', function (event) {
            event.preventDefault();
            _body.body.classList.toggle('mobile-menu-open');

            if (_body.body.classList.contains('mobile-menu-open')) {
                (0, _body.disableScroll)();
            } else {
                (0, _body.enableScroll)();
            }
        });
    }
}
...
;(function(factory) {
    'use strict';
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(123)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
function init() {
    ...
    var toggles = document.getElementsByClassName('search-overlay-toggle');

    for (var i = 0; i < toggles.length; i++) {
        toggles[i].addEventListener('click', function (event) {
            event.preventDefault();
            _body.body.classList.toggle('search-overlay-open');

            $('.search-overlay .slick-slider').slick('refresh');

            if (_body.body.classList.contains('search-overlay-open')) {
                (0, _body.disableScroll)();
            } else {
                (0, _body.enableScroll)();
            }
